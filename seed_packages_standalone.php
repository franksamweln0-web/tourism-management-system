...
<div class="container mt-5">
    <div class="card shadow">
        <div class="card-body">
            <h3>Package Seeding Results</h3>
            <ul class="list-group mt-3">
                <li class="list-group-item list-group-item-success">Added: <strong><?= $added ?></strong></li>
                <li class="list-group-item list-group-item-warning">Skipped (already exist): <strong><?= $skipped ?></strong></li>
                <li class="list-group-item list-group-item-info">Total: <strong><?= $total ?></strong></li>
            </ul>
            <?php if ($errors): ?>
            ...
            <?php endif; ?>
            <?php if ($added > 0): ?>
                <div class="alert alert-success mt-3">Successfully added <?= $added ?> new package(s).</div>
            <?php elseif ($skipped === $total): ?>
                <div class="alert alert-info mt-3">All packages already exist in the database.</div>
            <?php endif; ?>
            <p><a href="tourism_system/admin/manage_packages.php" class="btn btn-primary">Manage Packages</a></p>
            <p class="text-muted small mt-3">After running, delete this file for security.</p>
        </div>
    </div>
</div>
</body>
