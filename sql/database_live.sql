...
INSERT IGNORE INTO users (username, password, email, phone, role, status) VALUES
('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@tourism.com', '+255700000000', 'admin', 'active');

INSERT IGNORE INTO tour_packages (package_name, destination, duration_days, price, max_capacity, description, inclusions) VALUES
